...
@property(retain,nonatomic)NSArray*newsTitleArray,*lookNoArray,*dateArray,*webArray,*wordArray;
@property(retain,nonatomic)NSMutableArray*newsTitleArrayN,*lookNoArrayN,*dateArrayN,*webArrayN;
